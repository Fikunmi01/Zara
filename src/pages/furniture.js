...
export default function Furniture() {
  ...
  useEffect(() => {
    axios
      .get(
        "https://api.escuelajs.co/api/v1/categories/3/products?offset=0&limit=9"
      )
      .then((res) => {
  ...
  const fetchPage = async (currentPage) => {
    const res = await fetch(
      "https://api.escuelajs.co/api/v1/categories/3/products?offset=9&limit=18"
    );
    ...
    <>
      <div className="furniture-div">
        ...
        <div className="side-nav sideNavTwo">
          ...
          <Link className="clicked" to="/furniture">
            Furniture
          </Link>
        ...
        <div className="main-products-div">
          ...
          <span className="spaNtwo">
            <div className="side-nav">
              ...
              <Link to="/furniture" className="active">
